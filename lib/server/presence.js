...
function sessions(connnectionEvents, processEvents) {
  var processesOnline = _rxjs2.default.Observable.combineLatest(ticks, _batches.batchScan.call(processEvents, reduceToServerList, {}), removeDeadProcesses).map(Object.keys).distinctUntilChanged(_.isEqual);

  var allSessions = _batches.batchScan.call(connnectionEvents, reduceToSessionList, {});
